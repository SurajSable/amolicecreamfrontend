  ...
  return (
    <div className="position-relative">
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item mt-2">
                <Link className="nav-link active" aria-current="page" to="/">
                  <svg
                    ...
                    height={16}
                    fill="currentColor"
                    className="bi bi-house-gear-fill me- mb-1 "
                    viewBox="0 0 16 16"
                  >
              ...
              <li className="nav-item mt-2">
                <Link className="nav-link active" to="/shop"><StoreOutlinedIcon className="me-2"/>SHOP</Link>
              </li> 
      ...
      <ShoppingCartOutlinedIcon className="text-white "/>
           ...
           <Search />
            <ul className="navbar-nav  mb-2  float-right">
